...
export default function Jogador2() {
  ...
  return ( // Tudo o que está no RETURN aparece na tela
    <View style={styles.container} /* View principal do app */ >
      ...
      <Text style={styles.subTitulo1} /* Título do app */ >
          PLACAR:
        </Text>
      ...
      <View style={styles.container1}>
        ...
        <Text style={styles.pontos1} /* Mostra o valor dos pontos */>{pontos}</Text>
        <View style={styles.areaBotoes1} /* Área dos botões +1 e -1 */>
          <TouchableOpacity onPress={aumentar} style={styles.botao1}>
            <Text style={styles.textoBotao1}>+1</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={diminuir} style={styles.botao1}>
            <Text style={styles.textoBotao1}>-1</Text>
          </TouchableOpacity>
        </View>
        <TouchableOpacity onPress={resetar} style={styles.botaoReset1}>
          <Text style={styles.textoBotao1}>Resetar</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  container: { // Estilo da tela principal
    ...
    flexDirection: 'row',
    backgroundColor: '#fee0e6', // Cor de fundo
  ...
  botao: {
    backgroundColor: '#ff0066', // Cor do botão
  ...
  botaoReset: {
    backgroundColor: '#1bffff', // Cor do botão
    paddingVertical: 15, // Espaçamento vertical
  ...
  container1: { // Estilo da tela principal
    flex: '1', // Ocupa a tela inteira
    backgroundColor: '#fee0e6', // Cor de fundo
    alignItems: 'center', // Centraliza horizontalmente
    justifyContent: 'center', // Centraliza verticalmente
